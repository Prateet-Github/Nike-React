...
const [bigShoeImg, setbigShoeImg] = useState(bigShoe1)
  ...
  return (
    ...
    >
      <div className="relative xl:w-2/5 flex flex-col justify-center items-start w-full maz-xl:padding-x pt-28">
      ...
      <div className="flex justify-start items-start flex-wrap w-full mt-20 gap-16">
        {statistics.map((stat,index)=>(
          <div key={stat.label}>
            ...
            <p className="leading-7 font font-montserrat text-slate-gray">{stat.label}</p>
          </div>
        ))}
      </div>
